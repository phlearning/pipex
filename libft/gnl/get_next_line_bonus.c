...
/*   Updated: 2023/03/08 17:14:15 by pvong            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	ft_read_line(fd, buffer, &str[fd]);
	line = ft_get_line(&str[fd], &line);
	return (line);
}
...
int	main(void)
{
	...
	fd2 = open("/Users/pvong/Desktop/exo/42cursus/doctest2.txt", O_RDONLY);
	rd = 1;
